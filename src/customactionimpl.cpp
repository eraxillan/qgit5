...
void
CustomActionImpl::closeEvent( QCloseEvent* ce )
{
    QSettings settings;
...
void
CustomActionImpl::loadAction( const QString& name )
{
...
void
CustomActionImpl::removeAction( const QString& name )
{
    QSettings set;
...
void
CustomActionImpl::updateActions()
{
    QSettings settings;
...
void
CustomActionImpl::listWidgetNames_currentItemChanged( QListWidgetItem* item, QListWidgetItem* )
{
...
bool
CustomActionImpl::getNewName( QString& name, const QString& caption )
{
    bool ok;
...
void
CustomActionImpl::pushButtonNew_clicked()
{
    QString name;
...
void
CustomActionImpl::pushButtonRename_clicked()
{
...
void
CustomActionImpl::pushButtonRemove_clicked()
{
    QListWidgetItem* item = listWidgetNames->currentItem();
    if( !item || !item->isSelected() )
        return;
...
void
CustomActionImpl::pushButtonMoveUp_clicked()
{
    QListWidgetItem* item = listWidgetNames->currentItem();
...
void
CustomActionImpl::pushButtonMoveDown_clicked()
{
    QListWidgetItem* item = listWidgetNames->currentItem();
    int row = listWidgetNames->row( item );
...
void
CustomActionImpl::textEditAction_textChanged()
{
    QListWidgetItem* item = listWidgetNames->currentItem();
    if( item )
    {
...
void
CustomActionImpl::checkBoxRefreshAfterAction_toggled( bool b )
{
    QListWidgetItem* item = listWidgetNames->currentItem();
    if( item )
    {
...
void
CustomActionImpl::checkBoxAskArgs_toggled( bool b )
{
    QListWidgetItem* item = listWidgetNames->currentItem();
    if( item )
    {
...
void
CustomActionImpl::pushButtonOk_clicked()
{
    close();
}
