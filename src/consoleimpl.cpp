...
void
ConsoleImpl::typeWriterFontChanged()
{
...
void
ConsoleImpl::pushButtonOk_clicked()
{
    close();
}

void
ConsoleImpl::pushButtonTerminate_clicked()
{
...
void
ConsoleImpl::closeEvent( QCloseEvent* ce )
{
...
void
ConsoleImpl::procReadyRead( const QByteArray& data )
{
