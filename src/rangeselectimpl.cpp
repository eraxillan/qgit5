...
void
RangeSelectImpl::orderRefs( const QStringList& src, QStringList& dst )
{
    //
...
void
RangeSelectImpl::checkBoxDiffCache_toggled( bool b )
{
    setFlag( DIFF_INDEX_F, b );
}

void
RangeSelectImpl::checkBoxShowDialog_toggled( bool b )
{
    setFlag( RANGE_SELECT_F, b );
}

void
RangeSelectImpl::checkBoxShowAll_toggled( bool b )
{
...
void
RangeSelectImpl::checkBoxShowWholeHistory_toggled( bool b )
{
...
void
RangeSelectImpl::pushButtonOk_clicked()
{
