...
void
PatchView::buttonFilterPatch_clicked()
{
    QString ic;
...
void
PatchView::on_contextMenu( const QString& data, int type )
{
...
void
PatchView::lineEditDiff_returnPressed()
{
