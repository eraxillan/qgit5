...
class Git : public QObject
{
    ...
    void getDiffIndex();
    Rev* fakeRevData( SCRef sha, SCList parents, SCRef author, SCRef date, SCRef log, SCRef longLog,
    ...
    void mergeNearTags( bool down, Rev* p, const Rev* r,
                        const QHash< QPair< uint, uint >, bool >& dm );
...
public:
    ...
    static const bool optGoDown = true;  // TODO: private, enum
    static const bool optOnlyLoaded = true;
    static const bool optDragDrop = true;
    static const bool optFold = true;
    static const bool optAmend = true;        // TODO: enum
    static const bool optOnlyInIndex = true;  // TODO: private, enum
...
public:
    ...
    MyProcess* getHighlightedFile( SCRef fileSha, QObject* receiver, QString* result,
                                   SCRef fileName );
    ...
    const QString getDesc( SCRef sha, QRegExp& slogRE, QRegExp& lLogRE, bool showH,
                           FileHistory* fh );
